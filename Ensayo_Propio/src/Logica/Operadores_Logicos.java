...
public class Operadores_Logicos {
	...
	*/	
	...
	public static void EntradaDatos()
	{
		...
		System.out.print("Tipo de género (M/F): ");
		sexo = entrada.next().charAt(0);
		
		//System.out.println("Tu fecha de naciemiento es: " + fechaDeNacimiento);
		
		System.out.println("Hola " + nombre + " " + apellido + " tus datos son los siguientes: tienes " + edad + " años de edad y tu fecha de nacimiento es " + fechaDeNacimiento + " con sexo " + sexo);
	...
	public static void CocienteResiduo()
	{
		...
		System.out.printf("El resto de la división de %d y %d es: %d", numero1, numero2, resultResto);
